...
const Card=({movie}:{movie:Movie})=>{
    return(
        ...
        <Link href={`/movie/${movie.id}`} >
            <Image src={`https://image.tmdb.org/t/p/origin${movie.backdrop_path || movie.poster_path}`} width={300} height={300} alt="movie image" className=" sm:rounded-t-lg  w-full cursor-pointer group-hover:opacity-100 transition-opacity duration-300"></Image>
